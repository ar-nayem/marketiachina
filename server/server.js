...
app.use('/api/payment-methods', require('./src/routes/payment-methods.routes'));
app.use('/api/admin/payment-methods', require('./src/routes/admin-payment-methods.routes'));
app.use('/api', require('./src/routes/payments.routes').router);
...
app.use('/api/products', require('./src/routes/reviews.routes').productReviewsRouter);
app.use('/api/reviews', require('./src/routes/reviews.routes').reviewsRouter);
app.use('/api/admin/reviews', require('./src/routes/admin-reviews.routes'));
app.use('/api/admin/notifications', require('./src/routes/admin-notifications.routes'));
app.use('/api/admin/customers', require('./src/routes/admin-customers.routes'));
app.use('/api/admin/inventory', require('./src/routes/admin-inventory.routes'));
app.use('/api/admin/returns', require('./src/routes/admin-returns.routes'));
